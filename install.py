...
rDownloadURL = {"main": "https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/main_xui_servextex.zip", "sub": "https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/sub_xui_servextex.zip"}
import os
...
def prepare(rType="MAIN"):
    ...
    if not is_installed("libssl1.1"):
        ...
        subprocess.run("wget https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/libssl1.1_1.1.0g-2ubuntu4_amd64.deb > /dev/null 2>&1 && sudo dpkg -i libssl1.1_1.1.0g-2ubuntu4_amd64.deb > /dev/null 2>&1 && rm -rf libssl1.1_1.1.0g-2ubuntu4_amd64.deb > /dev/null 2>&1", shell=True)

    if not is_installed("libzip5"):
        printc("Installing libzip5")
        subprocess.run("wget https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/libzip5_1.5.1-0ubuntu1_amd64.deb > /dev/null 2>&1 && sudo dpkg -i libzip5_1.5.1-0ubuntu1_amd64.deb > /dev/null 2>&1 && rm -rf libzip5_1.5.1-0ubuntu1_amd64.deb > /dev/null 2>&1", shell=True)
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        rlink = "https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/update.zip"
    else:
        rlink = "https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/release_22f.zip"
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
...
if __name__ == "__main__":
    ...
    if not rVersion in rVersions:
        ...
        sys.exit(1)
    printc("X-UI installer in Ubuntu %s - Servextex" % rVersion, col.GREEN, 2)
    print(" ")
        ...
        if len(rHost) > 0 and len(rPassword) > 0 and rServerID > -1:
            ...
            if input("  ").upper() == "Y":
                ...
                if rType.upper() == "MAIN":
                    ...
                    rFile.write("your default player port is 25461\n")
                    rFile.write("your default mysql port is 7999\n")
                    rFile.close()
