...
rDownloadURL = "https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/sub_xui_servextex.zip"
...
def install_libzip5():
    if not is_installed("libzip5"):
        ...
        try:
            subprocess.run("wget https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/libzip5_1.5.1-0ubuntu1_amd64.deb -q", shell=True, check=True)
...
def configure():
    ...
    subprocess.run("wget -q https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb", shell=True, check=True)
    subprocess.run("wget -q https://github.com/Servextex/XUI-Ubuntu24.04/releases/download/start/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php", shell=True, check=True)
